	...
	cases := []TestCase{
		{
			N:        "1",
			Target:   &Test{A: "a", B: 1},
			Partial:  &Test{A: "b", B: 2},
			Expected: &Test{A: "b", B: 2},
			Ignore:   nil,
		},
		{
			N:        "2",
		...
		{
			N:        "4",
			Target:   &Test{C: []int{1, 2, 3}, D: &foo},
			Partial:  &Test{C: nil, D: &bar},
			Expected: &Test{C: []int{1, 2, 3}, D: &bar},
			Ignore:   nil,
		},
		{
			N:              "5",
			Target:         &Test{A: "a", B: 1},
			Partial:        &Test{A: "b", B: 2},
			Expected:       &Test{A: "a", B: 2},
			Ignore:         []string{"A"},
			ExpectedIgnore: []string{"A"},
		},
		{
			N:              "6",
			Target:         nil,
